...
int search(unsigned char *x, int m, unsigned char *y, int n) {
    ...
    _stats.memory_used = DSIGMA * sizeof(int) + m; // uses sentinel pattern so requires a copy of the pattern at the end of the text.
    _stats.num_lookup_entries1 = DSIGMA;
